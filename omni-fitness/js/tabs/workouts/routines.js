        ...
        <div class="rt-editor-item-fields">
            ${(function() {
                ...
                if (usesReps) {
                    ...
                    <div class="rt-editor-field-mini">
                        <label>Rep Min</label>
                        <input type="number" class="rt-input rt-input-xs ${errs[ek+'_reps']?'rt-input-error':''}" min="1" max="100" placeholder="—"
                            value="${item.repMin != null ? item.repMin : ''}"
                            oninput="rtUpdateItem('${item.id}','repMin', this.value === '' ? null : +this.value);rtInlineValidate('${ek}_reps',null)">
                        ${errs[ek+'_reps']?`<span class="rt-field-error">${errs[ek+'_reps']}</span>`:''}
                    </div>
                    <div class="rt-editor-field-mini">
                        <label>Rep Max</label>
                        <input type="number" class="rt-input rt-input-xs ${errs[ek+'_reps']?'rt-input-error':''}" min="1" max="100" placeholder="—"
                            value="${item.repMax != null ? item.repMax : ''}"
                            oninput="rtUpdateItem('${item.id}','repMax', this.value === '' ? null : +this.value);rtInlineValidate('${ek}_reps',null)">
                    </div>`;
                }
                ...
                if (usesWeight) {
                    ...
                    <div class="rt-editor-field-mini">
                        ...
                        <input type="number" class="rt-input rt-input-xs ${errs[ek+'_weight']?'rt-input-error':''}" min="0" step="0.5" placeholder="—"
                            value="${item.targetWeight != null ? item.targetWeight : ''}"
                            oninput="rtUpdateItem('${item.id}','targetWeight', this.value === '' ? null : +this.value);rtInlineValidate('${ek}_weight', this.value === '' ? null : +this.value)">
                ...
                if (usesDistance) {
                    ...
                    <div class="rt-editor-field-mini">
                        ...
                        <input type="number" class="rt-input rt-input-xs" min="0" step="0.1" placeholder="—"
                            value="${item.targetDistance != null ? item.targetDistance : ''}"
                            oninput="rtUpdateItem('${item.id}','targetDistance', this.value === '' ? null : +this.value)">
                    </div>`;
                }
