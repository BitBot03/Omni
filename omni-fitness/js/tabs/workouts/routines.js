...
function renderEditorItem(item, ii, total) {
    ...
    <div class="rt-editor-item" data-item-id="${item.id}">
        ...
        <div class="rt-editor-item-fields">
            ...
            <div class="rt-editor-field-mini">
                <label>RPE</label>
                <input type="number" class="rt-input rt-input-xs" min="1" max="10" step="0.5" placeholder="—"
                    value="${item.targetRPE||''}"
                    oninput="rtUpdateItem('${item.id}','targetRPE',+this.value||null)">
            </div>
            <div class="rt-editor-field-mini">
                <label>Tempo</label>
...
function renderPickerList() {
    ...
    return lib.map(e => {
        const muscle = e.primaryMuscle || e.muscle || '';
        return `
