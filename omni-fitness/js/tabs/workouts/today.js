            ...
            <div class="wkt-ring-col">
                <div class="wkt-ring-wrap" id="wktRingWrapOuter">
                    <svg class="wkt-svg" viewBox="0 0 320 320" aria-hidden="true" id="wktSvg">
                        <defs>
                            <mask id="outerMask">
                                <circle cx="160" cy="160" r="144" style="stroke: white !important; stroke-width: 16px;" fill="transparent" 
                                    stroke-dasharray="904.8 904.8" stroke-dashoffset="904.8" class="wkt-ring-progress" id="wktRingOuter" />
                            </mask>
                        ...
                        <g id="wktOuterSegments" mask="url(#outerMask)"></g>
